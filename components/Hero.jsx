...
const Hero = () => {
  ...
  return (
    <div>
      <section>
        <div className="grid px-10 mx-auto gap-8 xl:gap-0 laptop:py-8 lg:grid-cols-12 mb-24 mobile:mt-12 ">
          <AnimatePresence>
            {isMounted && (
              <>
                <motion.div
                ...
                >
                  ...
                  <p className="mobile:text-center text-slate-800 laptop:text-5xl mobile:text-xl my-6 tracking-tight laptop:text-left font-extrabold">Premium chemistry coaching for JEE (Main & Advanced), NEET & Boards.</p>
