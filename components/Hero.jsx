...
const Hero = () => {
  ...
  return (
    ...
    <section className="lg:mt-24 mx-auto max-w-screen-xl mb-10 px-4 items-center md:flex-row md:px-8 flex flex-col-reverse ">
        
    <div className="space-y-4 flex-1 sm:text-center lg:text-center">
        <h1 className="text-slate-800 text-center font-extrabold lg:text-6xl text-5xl">
...
<br /></p> */}
         <div className="flex pt-5 mt-0 items-center justify-center md:space-y-0 md:mt-0 md:pb-0 md:justify-start ">
