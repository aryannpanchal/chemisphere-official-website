  ...
  return (
    ...
    <div id="marketing-banner"  className="bg-slate-900 fixed bottom-6 z-50 flex flex-col md:flex-row justify-between w-[calc(100%-2rem)] p-4 -translate-x-1/2 border border-gray-100 rounded-lg shadow-sm lg:max-w-7xl left-1/2 dark:bg-slate-900 dark:border-gray-600">
      <div className="flex flex-col items-start mb-3 me-4 md:items-center md:flex-row md:mb-0">
        <Link href="https://chemisphere.in" className="flex items-center mb-2 border-gray-200 md:pe-4 md:me-4 md:border-e md:mb-0 dark:border-gray-600">
      ...
      <div className="flex items-center flex-shrink-0">
        <Link href="https://www.youtube.com/@Chemisphere?sub_confirmation=1" target='__blank' className="px-5 py-2 me-2 text-xs font-medium text-white bg-red-600 rounded-lg  focus:ring-4 focus:ring-blue-300 dark:bg-red-600  focus:outline-none dark:focus:ring-blue-800">Subscribe Now!</Link>
