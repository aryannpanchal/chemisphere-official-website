...
const mockup = () => {
  return (
    ...
    <div class="rounded-[2rem] overflow-hidden bg-white dark:bg-gray-800">
...
<div className="w-full p-4 mt-6 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-chemisphere dark:border-chemisphere">
      ...
      <div className="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
        <Link href="https://apps.apple.com/in/app/classplus/id1324522260" target='__blank'>
          <p className="w-full sm:w-auto bg-slate-900 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-slate-900 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
        ...
        <Link href="https://play.google.com/store/apps/details?id=co.lily.nydae" target='__blank'>
          <p className="w-full sm:w-auto bg-slate-900 hover:bg-slate-900 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-slate-900 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
