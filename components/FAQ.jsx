  ...
  return (
    <div>
      ...
      <div className="p-4 bg-white rounded-lg text-black max-w-7xl mx-auto border border-1 shadow text-md">
        <Accordion
          title={<h5 className='font-bold'>Why choose Chemisphere?</h5>}
        ...
        <hr />
        <Accordion
          title={<h5 className='font-bold'>How will students clarify their doubts?</h5>}
        ...
        /><hr />
        <Accordion
          title={<h5 className='font-bold'>How will tests be conducted?</h5>}
        ...
        <Accordion
          title={<h5 className='font-bold'>Will our child be in safe hands?</h5>}
        ...
        <Accordion
          title={<h5 className='font-bold'>Study materials are provided?</h5>}
