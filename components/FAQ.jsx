  ...
  return (
    <div>
      ...
      <div className="p-4 bg-white rounded-lg text-black border border-1 shadow text-md">
        <Accordion
          title={<h5 className='font-bold text-2xl'>Why choose Chemisphere?</h5>}
        ...
        <hr />
        <Accordion
          title={<h5 className='font-bold  text-2xl'>How will students clarify their doubts?</h5>}
        ...
        /><hr />
        <Accordion
          title={<h5 className='font-bold text-2xl'>How will tests be conducted?</h5>}
        ...
        <Accordion
          title={<h5 className='font-bold text-2xl'>Will our child be in safe hands?</h5>}
