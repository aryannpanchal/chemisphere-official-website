import {
  ...
  function NavbarSectionDashboard() {
    return (
      <>
      ...
      <div class=" w-full" id="navbar-dropdown">
        ...
        <div className="flex md:order-2">
          ...
          <Dropdown
            ...
            inline
            label={
              <Avatar alt="User settings" img="/bar.svg" className='md:w-fit md:h-fit w-5 h-5 laptop:ml-5'/>
            }
          >
 ...
 <div className="flex w-full justify-end laptop:mr-5 mobile:ml-5">
  ...
  export default NavbarSectionDashboard
