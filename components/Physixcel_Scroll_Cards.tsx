...
export default function Physixcel_Scroll_Cards() {
  return (
    <div className="laptop:flex mobile:flex-col sm:align-center p-10 pt-0">
      <h1 className='text-center text-5xl font-semibold pb-4'>Choose Your Physics Plan</h1>
      <div className="mt-12 space-y-3 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-6 md:max-w-5xl md:mx-12 xl:grid-cols-3">
        ...
        <div className="border border-slate-200 rounded-lg shadow-sm divide-y divide-slate-200">
          <div className="p-6">
            ...
            <p className="mt-2 text-base text-slate-700 leading-tight">Advanced Physics preparation with deep problem-solving focus.</p>
            <a href="/sign-up"
          ...
          <div className="pt-6 pb-8 px-6">
            ...
            <ul role="list" className="mt-4 space-y-3">
              <li className="flex space-x-3">✅ In-depth Conceptual Classes (Mechanics to Modern Physics)</li>
        ...
        <div className="border border-slate-200 rounded-lg shadow-sm divide-y divide-slate-200">
          <div className="p-6">
            ...
            <p className="mt-2 text-base text-slate-700 leading-tight">Integrated learning for Boards + Competitive Physics prep.</p>
            <a href="/sign-up"
              className="mt-8 block w-full bg-slate-900 rounded-md py-2 text-sm font-semibold text-white text-center">
              Proceed to Inquiry
            </a>
        ...
        <div className="border border-slate-200 rounded-lg shadow-sm divide-y divide-slate-200">
          <div className="p-6">
            ...
            <p className="mt-2 text-base text-slate-700 leading-tight">Score high in Board Physics with clarity & precision.</p>
            <a href="/sign-up"
              className="mt-8 block w-full bg-slate-900 rounded-md py-2 text-sm font-semibold text-white text-center">
              Proceed to Inquiry
            </a>
